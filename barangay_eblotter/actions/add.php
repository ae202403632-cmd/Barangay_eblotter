...
<div class="card-shell">
    <h2 class="card-title-main">Add Case Action</h2>
    ...
    <form action="insert.php" method="POST">
        <div class="mb-3">
            ...
            <select name="case_id" class="form-select" required>
                <?php while($c=$cases->fetch_assoc()): ?>
                    <option value="<?= $c['case_id'] ?>"><?= htmlspecialchars($c['case_title']) ?></option>
                <?php endwhile; ?>
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="action_details" class="form-control" rows="3"></textarea>
        </div>
