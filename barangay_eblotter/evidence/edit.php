...
$e = $conn->query("SELECT * FROM evidence WHERE evidence_id=$id")->fetch_assoc();
if(!$e){die("Evidence not found");}
...
<div class="card-shell">
    <h2 class="card-title-main">Edit Evidence</h2>
